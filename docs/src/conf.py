...
from robocrys.core import __version__
...
html_theme_options = {
    ...
    # "style_nav_header_background": "linear-gradient(0deg, rgba(23,63,162,1) 0%, "
    # "rgba(0,70,192,1) 100%)",
...
latex_documents = [
    (
        master_doc,
        "robocrystallographer.tex",
        "Robocrystallographer Documentation",
        "Alex Ganose",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "robocrys", "Robocrystallographer Documentation", [author], 1)
]
